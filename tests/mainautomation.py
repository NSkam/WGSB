...
core_path = "D:/Kostis Skamnelos/Desktop/tests"
...
os.system('python main_test1_gsb_maincore_density_corerank_constant_senpar.py 700 0.2 1 1 3 200 0.091')
os.system('python main_test1_gsb_maincore_density_corerank_constant_senpar.py 700 0.2 1 2 3 200 0.091')
os.system('python main_test1_gsb_maincore_density_corerank_constant_senpar.py 700 0.2 1 3 0 200 0.091')
os.system('python main_test1_gsb_maincore_density_corerank_constant_senpar.py 700 0.2 1 4 3 200 0.091')
os.system('python main_test1_gsb_maincore_density_corerank_constant_senpar.py 700 0.2 1 5 3 200 0.091')
os.system('python main_test1_gsb_maincore_density_corerank_constant_senpar.py 700 0.2 1 6 3 200 0.091')
#
#
